...
<div class="text-center">
    ...
    <div class="container py-5">
        ...
        @if ($lamaran->status == 'Pending')
            <p class="btn py-3 px-5 w-100 btn-success fs-3"><i class="bi bi-dash-circle-fill"></i> Pelamar Masih di Pending</p>
        @endif

        @if ($lamaran->status == 'Terima')
            <p class="btn py-3 px-5 w-100 btn-success fs-3"><i class="bi bi-check-circle-fill"></i> Pelamar Sudah Terima</p>
        @endif

        @if ($lamaran->status == 'Tolak')
            <p class="btn py-3 px-5 w-100 btn-danger fs-3"><i class="bi bi-x-circle-fill"></i> Pelamar Sudah Terima</p>
        @endif
    </div>
@endsection
