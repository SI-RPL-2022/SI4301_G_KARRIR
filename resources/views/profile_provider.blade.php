...
@section('content')
    <section id="Profile">
        <form action="/update/profile/{{ Auth::guard('perusahaan')->user()->id }}" method="POST" class="form-login"
            ...
            <div class="container py-5">
                ...
                <div class="row mb-5">
                    <div class="col-md-3 text-center">
                        ...
                        @else
                            <img src="{{ url('storage/' . Auth::guard('perusahaan')->user()->foto) }}"
                                class="mb-2 foto-profile" id="prev">
                        @endif



                        <!-- Button trigger modal -->
                        <button type="button" class="bg-transparent border-0 text-decoration-none link-secondary"
    ...
    <section id="InformasiUser" class="bg-informasi-user py-5">
            ...
            <div class="px-5">
                <div class="my-4">
                    ...
                    <div class="col px-5 mx-5">
                        <p class="text-center" id="deskripsi-text">
                            @if (!Auth::guard('perusahaan')->user()->tentang_kami)
                                Isi deskripsi perusahaanmu supaya pelamar dapat mengetahui informasi terkait perusahaan yang
                                kamu miliki
                            @else
                    ...
                    <div class="col px-5 mx-5">
                        ...
                        <div class="text-center">
                            <button type="button" class="bg-transparent border-0 text-decoration-none link-secondary"
                                data-bs-toggle="modal" data-bs-target="#visiModal">
                                <h6 class="fw-bold">
                    ...
                    <div class="col px-5 mx-5">
                        ...
                        <div class="text-center">
                            <button type="button" class="bg-transparent border-0 text-decoration-none link-secondary"
                                data-bs-toggle="modal" data-bs-target="#misiModal">
                                <h6 class="fw-bold">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="email" name="email" class="form-control bg-sekunder-2 mb-3"
                            placeholder="Perbarui Email" id="email"
                            value="{{ Auth::guard('perusahaan')->user()->email }}">

                        <input type="number" name="telepon" class="form-control bg-sekunder-2 mb-3"
                            placeholder="Telepon" id="telepon"
                            value="{{ Auth::guard('perusahaan')->user()->telepon }}">

                        <input type="text" name="alamat" class="form-control bg-sekunder-2 mb-3"
                            placeholder="Alamat" id="alamat" value="{{ auth()->user()->alamat }}">

                        <input type="text" name="industri" class="form-control bg-sekunder-2 mb-3"
                            placeholder="Industri Perusahaan" id="industri" value="{{ auth()->user()->industri }}">

                    </div>
                    <div class="modal-footer">
                        <button type="reset" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                        <button type="button" class="btn btn-primary" onclick="simpanInfo()"
        ...
        <div class="modal fade" id="deskripsiModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <p>Isi deskripsi perusahaanmu supaya pelamar dapat mengetahui informasi terkait perusahaan yang kamu
                            miliki</p>

                        <textarea class="form-control" rows="4" name="deskripsi" placeholder="Isi Deskripsi ..." id="deskripsi">{{ auth()->user()->tentang_kami }}</textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-bs-dismiss="modal" onclick="simpanDeskripsi()"
                            class="btn btn-primary px-5">Simpan</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="visiModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body text-center">
                        <p>Isi visi perusahaanmu supaya pelamar dapat mengetahui informasi terkait perusahaan yang kamu
                            miliki</p>

                        <textarea class="form-control" rows="4" name="visi" placeholder="Isi Visi ..." id="visi">{{ auth()->user()->visi }}</textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-bs-dismiss="modal" onclick="simpanVisi()"
                            class="btn btn-primary px-5">Simpan</button>
                    </div>
                </div>
            </div>
        ...
        <!--MISIIIIIIIIII Modal -->
        <div class="modal fade" id="misiModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body text-center">
                        <p>Isi misi perusahaanmu supaya pelamar dapat mengetahui informasi terkait perusahaan yang kamu
                            miliki</p>

                        <textarea class="form-control" rows="4" name="misi" placeholder="Isi Misi ..." id="misi">{{ auth()->user()->misi }}</textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-bs-dismiss="modal" onclick="simpanMisi()"
                            class="btn btn-primary px-5">Simpan</button>
                    </div>
                </div>
            </div>
